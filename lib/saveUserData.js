...
export async function saveUserData(userData, assessmentResults = null) {
  // Extract the required fields - UPDATED with consultant
  const { fullName, email, phone, consultant } = userData;
  ...
  const dataToSave = {
    ...
    consultant: consultant || 'Not provided', // NEW: Consultant field
